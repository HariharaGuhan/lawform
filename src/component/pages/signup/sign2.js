      ...
      <div className="container" style={{ fontFamily: "Figtree-Medium" }}>
        <div className="row">
          ...
          <div className="col-lg-4 mt-4  border" style={{backgroundColor: '#f3f3f3',borderRadius: "10px"}}>
            <form>
              <h4 className="text-center mt-2" style={{ fontSize: '18px',fontWeight: '900' ,lineHeight: '1.5'}}>Signup form for Users</h4>
              <h6 className="text-center mt-2" style={{ fontSize: '15px',fontWeight: '400' ,lineHeight: '1.5'}}>Fill in the Information Carefully</h6>
              <p className="text-center mt-2" style={{ fontSize: '14px',fontWeight: '400' ,lineHeight: '1.5'}}>These Contacts are used to Inform about orders</p>
              <h3 className="text-left mt-2 ml-5"style={{ fontSize: '20px',fontWeight: '900' ,lineHeight: '1.5'}}>Personal Data</h3>
          
       
              <div className="mb-3">
                <label style={{ fontSize: '14px',fontWeight: '400' ,lineHeight: '1.5'}}>Address</label><br/>
                <input type="text" className="input-field"  placeholder="Enter your address" style={{ border: 'none', borderBottom: '2px solid #e2e4e5', width:"100%" ,backgroundColor: 'transparent'}}/>
              </div>
              <div className="mb-3">
                <label style={{ fontSize: '14px',fontWeight: '400' ,lineHeight: '1.5'}}>Town/City</label>
                <input type="email" className="input-field"  placeholder="City or Town"style={{ border: 'none', borderBottom: '2px solid #e2e4e5' , width:"100%",backgroundColor: 'transparent'}}/> 
              </div>
              <div className="mb-3">
            ...
            <select id="district" value={selectedDistrict} onChange={handleDistrictChange} disabled={!selectedState}>
              ...
              <Link to="/schedule">
                  <button type="button" className="btn text-white w-100 text-center" style={{ background: "#ffc32a", fontSize: "16px", fontWeight: "500" }}>Register </button>
                                </Link>
              </div>
            </form>
          </div>
